...
*The project is built using an old version of visual studio, building with the new version did not work as intended, but in the future updates the project will be recreated with the latest version of visual studio and with cross platform support*
